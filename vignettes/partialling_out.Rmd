...
{tinyplot(res_fixest$res_bill_length_mm ~ 
         res_fixest$res_bill_depth_mm)
  tinyplot_add(res_fixest$res_bill_length_mm ~ 
               res_fixest$res_bill_depth_mm, type = "lm")}
...
{tinyplot(res_qnt$res_bill_length_mm ~ 
         res_qnt$res_bill_depth_mm)
  tinyplot_add(res_fixest$res_bill_length_mm ~ 
               res_fixest$res_bill_depth_mm, type = "lm")}
```
